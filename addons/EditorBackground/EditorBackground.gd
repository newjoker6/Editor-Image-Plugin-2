	...
	if is_instance_valid(tabContainer) and tabContainer.get_children():
		...
		for s in tabContainer.get_children():
			...
			if 'ScriptTextEditor' in s.name:
				print("tada")
				print(tabContainer.get_node(str(s.name)).get_child(0).name)
		...
		if is_instance_valid(base) and is_instance_valid(base.get_child(0)):
			...
			if base.get_child(0).get_child_count() >= 2:
				...
				if is_instance_valid(base.get_child(0).get_child(1)) and is_instance_valid(base.get_child(0).get_child(1).get_child(1)):
					...
					if is_instance_valid(vbox630.get_child(1).get_child(0).get_child(2).get_child(0).get_child(1).get_child(1).get_child(0)) and is_instance_valid(vbox630.get_child(1).get_child(0).get_child(2).get_child(0).get_child(1).get_child(1).get_child(0).get_child(0).get_child(0).get_child(0)):
						...
						if is_instance_valid(vbox630.get_child(1).get_child(0).get_child(2).get_child(0).get_child(1).get_child(1)):
